...
import it.unipr.cfg.type.numeric.integer.signed.RustI128Type;
import it.unipr.cfg.type.numeric.integer.signed.RustI16Type;
import it.unipr.cfg.type.numeric.integer.signed.RustI32Type;
import it.unipr.cfg.type.numeric.integer.signed.RustI64Type;
import it.unipr.cfg.type.numeric.integer.signed.RustI8Type;
import it.unipr.cfg.type.numeric.integer.signed.RustIsizeType;
import it.unipr.cfg.type.numeric.integer.unsigned.RustU128Type;
import it.unipr.cfg.type.numeric.integer.unsigned.RustU16Type;
import it.unipr.cfg.type.numeric.integer.unsigned.RustU32Type;
import it.unipr.cfg.type.numeric.integer.unsigned.RustU64Type;
import it.unipr.cfg.type.numeric.integer.unsigned.RustU8Type;
import it.unipr.cfg.type.numeric.integer.unsigned.RustUsizeType;
import it.unipr.cfg.type.primitive.RustBooleanType;
import it.unipr.cfg.type.primitive.RustCharType;
...
import it.unipr.frontend.visitor.RustCodeMemberVisitor;
import it.unipr.frontend.visitor.RustTypeVisitor;
...
public class RustFrontend extends RustBaseVisitor<Object> {
	...
	public Void visitItem(ItemContext ctx) {
		if (ctx.extern_mod() != null) {
			// As of now we are parsing only FFI and external variables, leaving
			// behind external crates
