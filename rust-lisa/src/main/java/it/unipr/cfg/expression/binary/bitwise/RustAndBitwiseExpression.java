package it.unipr.cfg.expression.binary.bitwise;
...
/**
 * Rust and bitwise expression (e.g., x & y).
 * 
 * @author <a href="mailto:vincenzo.arceri@unipr.it">Vincenzo Arceri</a>
 * @author <a href="mailto:simone.gazza@studenti.unipr.it">Simone Gazza</a>
 */
public class RustAndBitwiseExpression extends BinaryExpression {

	/**
	 * Builds the and bitwise expression.
	 * 
	 ...
	 */
	public RustAndBitwiseExpression(CFG cfg, CodeLocation location,
				...
				if (leftType.canBeAssignedTo(correctType) && correctType.canBeAssignedTo(leftType))
					result = result
							.lub(state.smallStepSemantics(new it.unive.lisa.symbolic.value.BinaryExpression(leftType,
									left, right, BitwiseAnd.INSTANCE, getLocation()), this));
			}
