...
/**
 * Rust subtraction expression (e.g., x - y).
 * 
 * @author <a href="mailto:vincenzo.arceri@unipr.it">Vincenzo Arceri</a>
 * @author <a href="mailto:simone.gazza@studenti.unipr.it">Simone Gazza</a>
 */
public class RustSubExpression extends BinaryExpression {
	 ...
	 */
	public RustSubExpression(CFG cfg, CodeLocation location,
				...
				if (leftType.canBeAssignedTo(rightType) && rightType.canBeAssignedTo(leftType))
					result = result
							.lub(state.smallStepSemantics(new it.unive.lisa.symbolic.value.BinaryExpression(leftType,
									left, right, NumericNonOverflowingSub.INSTANCE, getLocation()), this));
