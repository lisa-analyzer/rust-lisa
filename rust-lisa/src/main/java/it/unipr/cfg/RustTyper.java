...
public class RustTyper {
	 ...
	 * 
	 * @return {@link Untyped} if one of the expressions are {@link Untyped}, the
	 *         common static type otherwise
	 */
	 ...
	 * 
	 * @return {@link Untyped} if the expression is {@link Untyped}, the static type
	 *         otherwise
	 */
	...
	/**
	 * Types an expression: if it is unconstrained (int or float), then this method
	 * returns it as correctly typed.
	 * 
